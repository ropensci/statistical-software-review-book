...
```{r test, child = "standards/general.Rmd", eval = TRUE, echo = TRUE}
```

```{r test, child = "standards/bayesian.Rmd", eval = TRUE, echo = TRUE}
```

```{r test, child = "standards/regression.Rmd", eval = TRUE, echo = TRUE}
```

```{r test, child = "standards/unsupervised.Rmd", eval = TRUE, echo = TRUE}
```

```{r test, child = "standards/eda.Rmd", eval = TRUE, echo = TRUE}
```

```{r test, child = "standards/time-series.Rmd", eval = TRUE, echo = TRUE}
```
