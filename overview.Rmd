...
important questions which the project will have to address. A primary aim of
the project (described immediately below) is to build community, an aspect
considered in further detail towards the end of the present chapter.
...
chapter, and which comprise Chapters 4--7 of this book: Scope; the Peer Review
Process; Standards; and Software Assessment.

### Scope of Statistical Software Review

A core task will be to define the kinds of software that will be covered by our
...
statistical software. The following [Chapter 6](#process) on our proposed Peer
Review Process considers a few analogous processes of peer review, gleaning
aspects which may be useful to adopt and adapt for our system. It then
describes the series of steps we currently envision comprising our system,
drawing parallels throughout to extant systems for peer review of software,
primarily those of rOpenSci and JOSS. The proposed process relies on, and
partially reflects, notions of an open source software lifecycle, which we
accordingly describe in the final section of the current chapter.

### Software Assessment

The Software Assessment section in [Chapter 7](#assessment) presents a general
...
and in preparation for peer-review. It is important to consider how techniques
and metrics for software assessment may vary at different stages of the
software lifecycle described in the following section.
