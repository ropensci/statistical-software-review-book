...
chapter: Scope; the Peer Review Process; Standards; and Software Assessment.
...
within our review process are considered in [Chapter 4](#sope) below.
...
statistical software. The following [Chapter 5](#process) on our proposed Peer
...
primarily those of rOpenSci and JOSS.

The proposed process relies on, and partially reflects, notions of an open
source software lifecycle, which we accordingly describe in the final section
of the current chapter.

### Software Assessment

The Software Assessment section presents a general (yet non-exhaustive)
overview of aspects of software which may be usefully considered for
standards-based assessment, both for retrospective purposes of peer review, and
for prospective use in developing software both in general, and in preparation
for peer-review. It is important to consider how techniques and metrics for
software assessment may vary at different stages of the software lifecycle
