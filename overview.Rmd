...
statistical software. The following [Chapter 6](#lifecycle) on our proposed
Peer Review Process considers a few analogous processes of peer review,
gleaning aspects which may be useful to adopt and adapt for our system.
[Chapter 7](#process) then describes the peer review process in terms of the
series of steps we currently envision comprising our system.

### Software Assessment

The Software Assessment section in [Chapter 8](#assessment) presents a general
