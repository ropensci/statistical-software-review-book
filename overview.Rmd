...
This chapter lays out key considerations, outstanding questions and tasks for
purposes of generating community feedback for the project. It consists of the
following sections:
...
-   To provide software creators with a set of tools and standards to assess
    the quality of their work, and processes by which to improve it.
...
-   To provide statistical software developers, users, and consumers of results
    ...
    software quality and that may also serve as a symbol of professional
    credit.
...
-   To focus on R as primary language, but also to separate language-specific
    from language-agnostic components so as to maximize adaptability to other
    contexts.
