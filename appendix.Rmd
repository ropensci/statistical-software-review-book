...
```markdown
```{r template-request-not-latex, eval = !knitr::is_latex_output(), child="templates/request.md"}
```
```

```{r template-request, eval = knitr::is_latex_output(), child="templates/request.md"}
