...
results. The return object has an `summary` method which prints a formatted
...
function](hThe://ropenscilabs.github.io/pkgcheck/reference/pkgcheck.html) may
be seen by applying it to the skeleton [`srr` (**S**oftware **R**eview
**R**oclets) package](https://github.com/ropenscilabs/srr):
