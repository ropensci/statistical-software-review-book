...
category-specific standards (detailed in [Chapter 6](#standards)) offers
a formal *assurance* of software quality of a kind that extends well beyond the
conventional peer review process for non-statistical packages. Such assurance
of quality is particularly important in a number of fields, notably including
environments subject to regulatory requirements such as pharmaceutical
research. Software used in regulatory environments must generally be assured to
be of sufficient standard. This generally constrains software used in such
environments to a select few commercial, or well-established open source
systems. Open source software is generally not able to be used in regulated
environments. Our system of standards, and for documenting compliance within
code itself, is a system of regulation that will enable statistical software to
be used in such regulated environments. In more general terms, the *assurance*
of software quality facilitated by adherence to our standards should generally ...
