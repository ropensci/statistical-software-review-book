...
The **green** category is appropriate for software which developers see as
stable with little need for future development. The other two badges are for
software envisioned to remain under active development beyond initial review.
...
book are versioned, and that both **silver** and **gold** badges in particular
are assessed against the version of standards current at the time of review. As
these standards are upgraded, current versions may increasingly diverge from
versions against which badges were assessed. In the absence of ongoing software
maintenance, **gold** badges may eventually be downgraded to **silver**. We
will nevertheless make processes of ongoing alignment to standards as easy as
possible, and will include functions in our [`ssr`
package](https://ropenscilabs.github.io/srr/) to explicitly identify steps
necessary to re-align software with current versions of standards.
...
`statistical-software-review` repository, and saving it either in the root
directory of your repository, or in the `inst/` folder. The content of that
file is shown in the following sub-section.
