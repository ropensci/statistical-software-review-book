...
Packages must also have a "*Life Cycle Statement*", which must be appended to
a repository's [`CONTRIBUTING.md`
...
```
Following review, this package will
...
removing references to the review process, and changing all tense to present
("The package is in a stable state of development ...") Additional information
on envisioned software development can be added at any stage, as in [this
