...
127. [`rsimsum`](https://joss.theoj.org/papers/10.21105/joss.00739): Monte Carlo, estimates, simulation, wrapper; input: data.frame, ML data; output: summary statistics, visualization
