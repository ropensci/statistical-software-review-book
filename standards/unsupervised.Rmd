...
- [**UL3.1**]{#UL3_1} *Algorithms which apply sequential labels to input data
...
- [**UL3.2**]{#UL3_2} *Dimensionality reduction or equivalent algorithms which
...
- [**UL3.3**]{#UL3_3} *Unsupervised Learning Software for which input data does
...
- [**UL3.4**]{#UL3_4} *Where applicable, Unsupervised Learning Software should
...
- [**UL3.5**]{#UL3_5} *Objects returned from Unsupervised Learning Software
...
- [**UL4.2**]{#UL4_2} *Model objects returned by Unsupervised Learning Software
  ...
  of the output data or results.*
    - [**UL4.2a**]{#UL4_2a} *The default `print` method should always ensure
...
- [**UL4.3**]{#UL4_3} *Unsupervised Learning Software should also implement
