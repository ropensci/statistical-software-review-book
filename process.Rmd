...
an approach we intend to adopt. There are also notable differences between
these two systems, with contrasts between them often providing convenient
reference points in considering many of the following phases we envision
developing. The following sub-sections consider a couple of further models,
highlighting aspects which might be productively incorporated in peer-review of
statistical software.

### Academic Journal Reviews

One ubiquitous model for processes of peer review is that of "standard"
academic journals, for which one important aspect of likely relevance for the
present project is the division of labour between editors. Academic journals
commonly have a board of (primary) editors, and a field of (secondary) subject
or specialist editors. The initial and terminal points of review processes are
commonly handled by the primary editors, who delegate subject editors to both
solicit appropriate reviewers, and to manage the review process. Upon
completion, the primary editor generally signifies ultimate acceptance. 

Such a model would also likely be beneficial for the present project, although
attracting sufficient numbers of subject editors may prove difficult. There
would nevertheless be distinct advantages, foremost among which would be an
ability to appoint a reasonably large number of "subject editors" (or
equivalent), for whom such an official designation would be able to be used to
boost their own careers. As a contrast, rOpenSci current has eight editors who
handle all submissions, from whom four are staff members. The preceding
consideration of [categories](#scope) suggests we may end up with around
a dozen categories, and so potentially be able to offer around three times the
number of honorary subject editor positions (availability of such
notwithstanding), along with a concomitant reduction in workload for each of
them. Engaging such a range of subject editors would also lessen the burden on
primary editors, perhaps enabling the system to be initially trialled with the
two or three people primarily engaged in its current developmental phase. The
engagement of a wider range of subject editors would also enlarge the network
of people directly engaged with the project, as well as extending its sphere of
influence to encompass the professional networks of all those involved.

***Proposal***

1. The rOpenSci staff directly involved in the development of this project
   serve as primary editors, and we seek to find and nominate subject editors
   as soon as we have reached agreement on categories of statistical software.
...
system proposed here in being centred around trusted and verified people rather
than software. Submission of software to Debian is largely automatic, and
bug-free software may often progress automatically through various stages of
acceptance. Software may, however, only be submitted by official Debian
Maintainers or Developers, for which people must be sponsored by extant
members, and are then subject to review of the potential contribution they may
be able to make to the broader Debian community. (Details can be seen in [this
chapter of the Debian
...
however. It just means that no-one has yet reviewed the package with changes to
the standards in mind.

Upgrading to match the ongoing development of standards is always possible, but
as that quote indicates, is a process subject to ongoing review. Each new
version of the standards is accompanied by a simple
...
previous versions. We propose to adopt aspects of the Debian system in the
present project, as described below.
...
important aim to to develop tools able to be used by software authors to assess
...
and via password for restricted access.
...
current project would like to do better than its two main precedents. Debian's
LDAP system may be interpreted to represent current best-practice standards for
maintenance of such databases. 
...
categories, although it is important to note that this would exclude review
...
guidelines on review practices. We intend to continue such cultural practices,
while at the same time aiming to develop a system for more structured yet
discursive input, in order both to provide more focussed software reviews, and
to lessen the burden on reviewers. We anticipate commencing the development of
such structure in subsequent iterations of the present document.
